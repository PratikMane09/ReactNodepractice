    ...
    <div className="row row-cols-1 row-cols-md-3 g-4">
                {
                    products.map((item, index) => {
                        return(
                            ...
                            {/* <Link to="/Singleproduct" key={item._id} className='product-link'> */}
                                <div className="col ">
                                    <Card style={{ width: '18rem'}} key={index}>
                                        <Card.Img variant="top" className='w-50 mx-auto d-block' src={`http://localhost:4000/api/product/getphoto/${item._id}`} />
                                        <Card.Body>
